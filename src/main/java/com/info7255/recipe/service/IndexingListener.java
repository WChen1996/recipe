...
public class IndexingListener {
    ...
    private static final String INDEX_NAME = "plan";
    private LinkedHashMap<String, Map<String, Object>> MapOfDocuments;
    ...
    public void handleMessage(Map<String, String> message) throws IOException {
    ...
    private void postDocument(JSONObject plan) throws IOException {
        ...
        for (Map.Entry<String, Map<String, Object>> entry : MapOfDocuments.entrySet()) {
            String parentId = entry.getKey().split("_")[0];
            String objectId = entry.getKey().split("_")[1];
    ...
    private Map<String, Map<String, Object>> convertMapToDocumentIndex (JSONObject jsonObject,
        ...
        while (iterator.hasNext()){
            ...
            String redisKey = jsonObject.get("objectType") + "_" + parentId;
            Object value = jsonObject.get(key);
    ...
    private XContentBuilder getMapping() throws IOException {
        ...
        builder.startObject();
        {
            builder.startObject("properties");
            {
                ...
                builder.endObject();
                builder.startObject("plan_relationship");
                {
